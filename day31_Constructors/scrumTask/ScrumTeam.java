...
public class ScrumTeam {
    ...
    public String toString() {
        return "ScrumTeam{" +
                ...
                ", BA='" + BA + '\'' +
                ", SM='" + SM + '\'' +
                ", total number of testers=" + testersList.size() + //modified the original toString method
                ", total number of developers =" + devopsList.size() + //modified the original toString method
