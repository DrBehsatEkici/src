...
public class StringIntro {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s1.equals (s2)); //when you compare objects use equals method

        String s3 = "Java";
        String s4 = new String ("java");
        System.out.println(s3.equals(s4)); //false because java is a case sensitive language
