...
public class StringMethods {
    ...
    public static void main(String[] args) {
        ...
        // in order to ignore the case sensitivity we first create the lover case of uppoer case version of string
        // and then compare it with the lovercase and uppercase.
