...
public class ArraysPractice1 {
    ...
    public static void main(String[] args) {
        ...
        // we know the number of elements and what they are
        ...
        for (int i = 0; i < months.length; i++) { // i represents the index numbers starting from 0
            ...
            for (int i = months.length - 1; i >= 0; i--) { // i represents the index numbers starting from 11
                System.out.println(months[i]);

                // printing the reverse months
            }
        
        
        /* You should always use loops instead of doing one by one 
