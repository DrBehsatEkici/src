...
public class Student {
    ...
    // We need to overload the method. The only way that we can have multiple constructor in the class is overloading.
    //method overloading multiple different methods having the same method name but different parameters
// one constructor can all only one constructor
// we need to create the toString method when we create objects in constructor methods.
